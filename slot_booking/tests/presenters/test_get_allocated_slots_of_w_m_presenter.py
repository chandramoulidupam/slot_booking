...
from slot_booking.presenters.get_allocated_slots_for_w_m_presenter_implementation import \
    GetAllocatedSlotsPresenterImplementation
from slot_booking.presenters.upcoming_slots_presenter_implementation import UpcomingSlotsPresenterImplementation


def test_get_alllocated_slots_with_valid_details_returns_list_of_slots(snapshot):
    presenter = GetAllocatedSlotsPresenterImplementation()
    # now.strftime("%H:%M:%S")
    list_of_slot_dtos = [
        UserSlotDto(
    ...
    response = presenter.get_allocated_slots_for_washing_machine(list_of_slot_dtos)
...
def test_get_allocated_slots_with_invalid_washing_number_raises_exception(snapshot):
    presenter = GetAllocatedSlotsPresenterImplementation()
...
def test_get_allocated_slots_when_user_is_not_admin_raises_exception(snapshot):
    presenter = GetAllocatedSlotsPresenterImplementation()
